...
{
        name='upspeedf', arg='wlp3s0', max=5120,
      bg_colour=0x111111, bg_alpha=0.4,
...
{
        name='downspeedf', arg='wlp3s0', max=5120,
      bg_colour=0x111111, bg_alpha=0.4,
...
{
        name='wireless_link_qual_perc', arg='wlp3s0', max=100,
      bg_colour=0x111111, bg_alpha=0.4,
